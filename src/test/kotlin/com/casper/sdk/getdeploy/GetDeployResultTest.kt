    ...
    fun getDeployFromJsonStr() {
        ...
        try {
            ...
            if(getDeployResult2 != null) {
                ...
                var session2Value = getDeployResult2.deploy.session.itsValue[0] as ExecutableDeployItem_StoredContractByHash
