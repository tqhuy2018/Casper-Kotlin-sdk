...
internal class GetDeployResultTest {
    ...
    fun getDeployFromJsonStr() {
       ...
       // getDeployParams.deploy_hash = "ca0b2dc4dd552a638e90c5102c8808d04936c2428fa96bf6cfb26d9148269fdb"
        ...
        val payment: ExecutableDeployItem_ModuleBytes = deploy.payment.itsValue[0] as ExecutableDeployItem_ModuleBytes
        assert(payment.args.listNamedArg.count() == 1)
        val session:ExecutableDeployItem_ModuleBytes = deploy.session.itsValue[0] as ExecutableDeployItem_ModuleBytes
        assert(session.args.listNamedArg.count() == 17)
        //assert for payment first arg - CLType_U512
        val paymentNA:NamedArg = payment.args.listNamedArg[0] as NamedArg
        ...
        val sessionNA:NamedArg = session.args.listNamedArg[0] as NamedArg
        ...
        val sessionNA2:NamedArg = session.args.listNamedArg[1] as NamedArg
        ...
        val sessionNAKey:NamedArg = session.args.listNamedArg[3] as NamedArg
        ...
        val sessionNA3:NamedArg = session.args.listNamedArg[4] as NamedArg
        ...
        val sessionNAString:NamedArg = session.args.listNamedArg[6] as NamedArg
        ...
        val sessionNAU64:NamedArg = session.args.listNamedArg[7] as NamedArg
        ...
        val sessionNAOption:NamedArg = session.args.listNamedArg[13] as NamedArg
        ...
        //assertion for session 13th item with CLValue of CLType Option(U64)
        val sessionNAOption2:NamedArg = session.args.listNamedArg[14] as NamedArg
        ...
        val sessionNAU32:NamedArg = session.args.listNamedArg[16] as NamedArg
        ...
        var session2Value = ExecutableDeployItem_StoredContractByHash()
        ...
        val na1:NamedArg = session2Value.args.listNamedArg[0] as NamedArg
        ...
        val naBool:NamedArg = session2Value.args.listNamedArg[4] as NamedArg
        ...
        val payment3:ExecutableDeployItem_ModuleBytes = getDeployResult3.deploy.payment.itsValue[0] as ExecutableDeployItem_ModuleBytes
        ...
        val session3:ExecutableDeployItem_StoredContractByHash = getDeployResult3.deploy.session.itsValue[0] as ExecutableDeployItem_StoredContractByHash
    ...
    //Test 7 Transform of type WriteWithdraw and WriteBid - from MAINNET
        ...
        var ediSession6 : ExecutableDeployItem_ModuleBytes = ExecutableDeployItem_ModuleBytes()
        ediSession6 = getDeployResult6.deploy.session.itsValue[0] as ExecutableDeployItem_ModuleBytes
        ...
        var ediSession7 : ExecutableDeployItem_ModuleBytes = ExecutableDeployItem_ModuleBytes()
        ediSession7 = getDeployResult7.deploy.session.itsValue[0] as ExecutableDeployItem_ModuleBytes
