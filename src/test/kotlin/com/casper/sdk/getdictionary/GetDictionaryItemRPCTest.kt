...
internal class GetDictionaryItemRPCTest {
    ...
    fun getDictionaryItem() {
        ...
        val diContractNamedKey: DIContractNamedKey = DIContractNamedKey()
        ...
        val di2: DictionaryIdentifier = DictionaryIdentifier()
        di2.itsType = ConstValues.DI_CONTRACT_NAMED_KEY
        di2.itsValue.add(diContractNamedKey)
        val getDictionaryItemParams2 :  GetDictionaryItemParams = GetDictionaryItemParams()
        ...
        val diDictionary :  DIDictionary = DIDictionary()
        diDictionary.itsValue = "dictionary-5d3e90f064798d54e5e53643c4fce0cbb1024aadcad1586cc4b7c1358a530373"
        val di4: DictionaryIdentifier = DictionaryIdentifier()
        di4.itsType = ConstValues.DI_DICTIONARY
        di4.itsValue.add(diDictionary)
        val getDictionaryItemParams4 :  GetDictionaryItemParams = GetDictionaryItemParams()
        ...
        //Error is thrown
        val diDictionary2 :  DIDictionary = DIDictionary()
        diDictionary2.itsValue = "dictionary-5d3e90f064798d54e5e53643c4fce0cbb1024aadcad1586cc4b7c1358a530373"
        val di5: DictionaryIdentifier = DictionaryIdentifier()
        di5.itsType = ConstValues.DI_DICTIONARY
        di5.itsValue.add(diDictionary)
        val getDictionaryItemParams5 :  GetDictionaryItemParams = GetDictionaryItemParams()
        ...
        val diAccountNamedKey2: DIAccountNamedKey = DIAccountNamedKey()
        ...
        val di6: DictionaryIdentifier = DictionaryIdentifier()
        di6.itsType = ConstValues.DI_ACCOUNT_NAMED_KEY
        di6.itsValue.add(diAccountNamedKey2)
        val getDictionaryItemParams6 :  GetDictionaryItemParams = GetDictionaryItemParams()
